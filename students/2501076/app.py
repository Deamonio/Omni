...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://s2501076:yeonjun0103@localhost/student_db'
...
class User(db.Model):
    ...
    hobby = db.Column(db.String(100))     #신규
