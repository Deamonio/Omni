...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://s2301301:moonsung121200@localhost/student_db'
...
class User(db.Model):
    ...
    phone = db.Column(db.String(15))    #신규
    email = db.Column(db.String(50))    #신규
