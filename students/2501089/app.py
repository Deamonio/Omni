...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://s2501089:star88222@localhost/student_db'
...
class User(db.Model):
    ...
    post = db.Column(db.String(5))
    hobby = db.Column(db.String(5))       #신규
...
def signup():
    if request.method == 'POST':
        ...
        new_user = User(
            ...
            hobby=request.form.get('hobby')          #신규
        )
